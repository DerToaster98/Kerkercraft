...
public class KCConstants {
	...
	public static class JEI {
		public static final ResourceLocation PLUGIN_ID = Kerkercraft.prefix("jei_plugin");
		
		public static final ResourceLocation NPC_TRADE_CATEGORY_UID = Kerkercraft.prefix("jei/category/npc_trade");
	}
