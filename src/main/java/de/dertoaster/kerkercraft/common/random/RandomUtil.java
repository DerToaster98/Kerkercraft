package de.dertoaster.kerkercraft.common.random;
...
public class RandomUtil {
	...
	public static <T> T getOrThrow(WeightedList<T> weightedRandomList, RandomSource random) {
		return weightedRandomList.getRandom(random).orElseThrow();
	}
