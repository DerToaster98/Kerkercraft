...
public class KCItems {
    ...
    // TODO: Proper custom item implementation!
    public static DeferredItem<Item> SLIME_HELMET = KCServices.ITEM.registerHelmet("slime_helmet", KCArmorMaterials.SLIME, Item::new);
    public static DeferredItem<Item> SLIME_CHESTPLATE = KCServices.ITEM.registerHelmet("slime_chestplate", KCArmorMaterials.SLIME, Item::new);
    public static DeferredItem<Item> SLIME_LEGGINGS = KCServices.ITEM.registerHelmet("slime_leggings", KCArmorMaterials.SLIME, Item::new);
    public static DeferredItem<Item> SLIME_BOOTS = KCServices.ITEM.registerHelmet("slime_boots", KCArmorMaterials.SLIME, Item::new);
    ...
    public static DeferredItem<Item> DYABLE_GOLD_HELMET = KCServices.ITEM.registerHelmet("dyable_gold_helmet", KCArmorMaterials.DYABLE_GOLD, Item::new);
    public static DeferredItem<Item> DYABLE_GOLD_CHESTPLATE = KCServices.ITEM.registerHelmet("dyable_gold_chestplate", KCArmorMaterials.DYABLE_GOLD, Item::new);
    public static DeferredItem<Item> DYABLE_GOLD_LEGGINGS = KCServices.ITEM.registerHelmet("dyable_gold_leggings", KCArmorMaterials.DYABLE_GOLD, Item::new);
    public static DeferredItem<Item> DYABLE_GOLD_BOOTS = KCServices.ITEM.registerHelmet("dyable_gold_boots", KCArmorMaterials.DYABLE_GOLD, Item::new);

    public static DeferredItem<Item> DYABLE_IRON_HELMET = KCServices.ITEM.registerHelmet("dyable_iron_helmet", KCArmorMaterials.DYABLE_IRON, Item::new);
    public static DeferredItem<Item> DYABLE_IRON_CHESTPLATE = KCServices.ITEM.registerHelmet("dyable_iron_chestplate", KCArmorMaterials.DYABLE_IRON, Item::new);
    public static DeferredItem<Item> DYABLE_IRON_LEGGINGS = KCServices.ITEM.registerHelmet("dyable_iron_leggings", KCArmorMaterials.DYABLE_IRON, Item::new);
    public static DeferredItem<Item> DYABLE_IRON_BOOTS = KCServices.ITEM.registerHelmet("dyable_iron_boots", KCArmorMaterials.DYABLE_IRON, Item::new);

    public static DeferredItem<Item> DYABLE_DIAMOND_HELMET = KCServices.ITEM.registerHelmet("dyable_diamond_helmet", KCArmorMaterials.DYABLE_DIAMOND, Item::new);
    public static DeferredItem<Item> DYABLE_DIAMOND_CHESTPLATE = KCServices.ITEM.registerHelmet("dyable_diamond_chestplate", KCArmorMaterials.DYABLE_DIAMOND, Item::new);
    public static DeferredItem<Item> DYABLE_DIAMOND_LEGGINGS = KCServices.ITEM.registerHelmet("dyable_diamond_leggings", KCArmorMaterials.DYABLE_DIAMOND, Item::new);
    public static DeferredItem<Item> DYABLE_DIAMOND_BOOTS = KCServices.ITEM.registerHelmet("dyable_diamond_boots", KCArmorMaterials.DYABLE_DIAMOND, Item::new);

    public static DeferredItem<Item> DYABLE_NETHERITE_HELMET = KCServices.ITEM.registerHelmet("dyable_netherite_helmet", KCArmorMaterials.DYABLE_NETHERITE, Item::new, c -> c.fireResistant());
    public static DeferredItem<Item> DYABLE_NETHERITE_CHESTPLATE = KCServices.ITEM.registerHelmet("dyable_netherite_chestplate", KCArmorMaterials.DYABLE_NETHERITE, Item::new, c -> c.fireResistant());
    public static DeferredItem<Item> DYABLE_NETHERITE_LEGGINGS = KCServices.ITEM.registerHelmet("dyable_netherite_leggings", KCArmorMaterials.DYABLE_NETHERITE, Item::new, c -> c.fireResistant());
    public static DeferredItem<Item> DYABLE_NETHERITE_BOOTS = KCServices.ITEM.registerHelmet("dyable_netherite_boots", KCArmorMaterials.DYABLE_NETHERITE, Item::new, c -> c.fireResistant());
